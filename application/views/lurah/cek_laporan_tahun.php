                                    ...
                                    <div class="card-body">
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $tahun = $_GET['tahun'];
                                $queryj = $this->db->query("SELECT  COUNT(*) AS jumlah FROM masyarakat inner join jawaban_user on masyarakat.id_masyarakat = jawaban_user.id_masyarakat where jawaban_user.id_kategori='$kategori->id_kategori' AND YEAR(jawaban_user.tanggal) = '$tahun'")->row();
                                $count= $queryj->jumlah;
                                $queryv =$this->db->query("SELECT * FROM masyarakat inner join jawaban_user on masyarakat.id_masyarakat = jawaban_user.id_masyarakat where jawaban_user.id_kategori='$kategori->id_kategori' AND YEAR(jawaban_user.tanggal) = '$tahun'");
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <table class="table table-bordered table-striped">
                                            ...
                                            $query = $this->db->query("SELECT * FROM masyarakat inner join jawaban_user on masyarakat.id_masyarakat = jawaban_user.id_masyarakat where jawaban_user.id_kategori='$kategori->id_kategori'  AND YEAR(jawaban_user.tanggal) = '$tahun'")->result();
                                            foreach ($query as $k) {
                                            ?>
                                            <tr>
                                                <td><?= $no++; ?></td>
